package com.yoke.yokepicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // yoke_picture.picture_112321321,yoke_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "yoke_picture." + tableName) // 确保前缀合法
